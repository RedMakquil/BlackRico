...
if (Config.WORKTYPE == 'private') {
    ...
    Rico.addCommand({pattern: 'BLACK ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Rico.addCommand({pattern: 'menu ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
