...
const need = "*type some word after command*"
 if (Config.WORKTYPE == 'private') {
    ...
    Rico.addCommand({ pattern: 'logogalaxy ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    Rico.addCommand({ pattern: 'logov2 ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    Rico.addCommand({ pattern: 'gamelogo ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Rico.addCommand({ pattern: 'logogalaxy ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
    ...
    Rico.addCommand({ pattern: 'logov2 ?(.*)', fromMe: false,dontAddCommandList: true }, (async (message, match) => {
    ...
    Rico.addCommand({ pattern: 'gamelogo ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
