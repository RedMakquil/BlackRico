...
const fs = require("fs")
const asena = fs.readFileSync('./media/hi.mp3') 
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'RICO ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'RICO ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
