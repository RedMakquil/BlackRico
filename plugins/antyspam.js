/*Copyright (C) 2021 Black Amda  /  Copyright (C)DINUKA*/
...
Rico.addCommand({ pattern: 'wakeup ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.TAGALL_DESC, dontAddCommandList: true }, (async (message, match) => {
...
Rico.addCommand({ pattern: 'activate', fromMe: true, deleteCommand: false, desc: AS_DESC, }, (async (message, match) => {
...
Rico.addCommand({ pattern: 'off', fromMe: true, delownsewcmd: false, desc: AS_DESC, }, (async (message, match) => {
