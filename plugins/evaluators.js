...
Rico.addCommand({pattern: 'term ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.TERM_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
antlch()
var ldc = ''
if (Config.LANG == 'SI') ldc = '_❌ ලින්ක් ${conn.user.name}! විසින් තහනම් කර ඇත_'
if (Config.LANG == 'EN') ldc = '_❌ Link Detected!_'
Rico.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
