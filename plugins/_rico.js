...
const dmenu = "💠📃 ●BLACK RICO PANEL● 📃💠\n\n"


Rico.addCommand({pattern: 'RICO '?(.*)', fromMe: false, dontAddCommandList: true, deleteCommand: false,}, (async (message, match) => {
    ...
    if (match[1] === '') {
        ...
        await message.client.sendMessage(message.jid, rico, MessageType.audio, {mimetype: 'audio/mp4', ptt:true}, {quoted: message.data})
        await message.client.sendMessage(message.jid, '⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍\n' + ' ```⚕️⛨ BLACK RICO PANEL ⛨⚕️```\n' + '⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎⚎\n' + CMD_HELP, MessageType.text, {quoted: message.data});
